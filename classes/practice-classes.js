...
const newCharacter = new Character("Luigi", "human");
newCharacter.getInfo();
...
const newNPC = new NPC(
  ...
  "human",
  "earth",
  "What brings a pirate like yourself to this peaceful township?"
);
newNPC.dialogue();
...
class Hero extends Player {
  ...
  addSuperPower(powerString) {
    this.superPowers.push(powerString);
  }
  useSuperPower(index) {
...
fireSpitter.addSuperPower("swim");
